...
def train_random_forest(
    ...
    # Specificity: cẩn thận khi chỉ có 1 lớp trong y_test
...
def run_all_fingerprints(fingerprints, num_runs=3, base_prefix="3.InFlamNat"):
    ...
    for fp in fingerprints:
        ...
        try:
            ...
            y_test = pd.read_csv("AISMPred_y_test.csv", index_col=0).values.ravel()
        ...
        for run in range(num_runs):
            seed = 42 + run  # thay đổi seed cho mỗi run
