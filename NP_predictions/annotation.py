...
FILE2   = "/home/andy/andy/Inflam_NP/NP_predictions/NPASS_candidates_final.csv"          # chứa canonical_smiles, ID, lipinski_rule_of_five_violations, sa_score
OUTPUT  = "NPASS_common_scaffold_hopping_annotated.csv"
...
df_merged = pd.merge(
    df1,
    df2[["canonical_smiles", "ID", "lipinski_rule_of_five_violations", "sa_score"]],
    on="canonical_smiles",
