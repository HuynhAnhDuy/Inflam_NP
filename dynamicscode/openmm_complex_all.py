...
def input_argument():
    ...
    parser.add_argument("-p", "--protein", default=os.path.join('mols',"4xv2_nomolecule_fixed.pdb"), help="Protein PDB file")
    ...
    parser.add_argument("-s", "--steps", type=int, default=10000, help="Number of steps")
