...
# ========= CẤU HÌNH =========
CSV_PATH = "/home/andy/andy/Inflam_NP/Scaffold_identify/shap_scaffold_split_XGB_20250923_122035/scaffold_positive_overlap.csv"   # <-- CSV input
ID_COL = "ID"
SCAFFOLD_COL = "scaffold"
SHAP_COL = "mean_shap"

N = 16                                # số scaffold muốn vẽ
OUT_DIR = "/home/andy/andy/Inflam_NP/Scaffold_identify/shap_scaffold_split_XGB_20250923_122035"
...
for i, row in scaffolds.iterrows():
    ...
    legend = f"{mol_id} - mean SHAP: {mean_shap:.4f}"
