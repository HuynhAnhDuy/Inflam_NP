...
# Đọc dữ liệu
x_train = pd.read_csv("/home/andy/andy/Inflam_NP/preprocessing/InFlam_full.csv")
x_test = pd.read_csv("/home/andy/andy/Inflam_NP/preprocessing/Coconut_NP_similar_modified.csv")
...
# Xuất ra file mới
x_train_modified.to_csv("Coconut_NP_similar_modified_x_train.csv", index=False)
