...
# Đọc dữ liệu
x_train = pd.read_csv("/home/andy/andy/Inflam_NP/preprocessing/3.InFlamNat_final.csv")
x_test = pd.read_csv("/home/andy/andy/Inflam_NP/preprocessing/AISMPred_x_test_preprocess.csv")
...
# Xuất ra file mới
x_train_modified.to_csv("3.InFlamNat_x_train.csv", index=False)
