...
x_test = pd.read_csv("/home/andy/andy/Inflam_NP/preprocessing/NPASSv2.0_filtering_SA3.csv")
...
# Xuất ra file mới
x_train_modified.to_csv("NPASS_modified_x_train_SA3.csv", index=False)
