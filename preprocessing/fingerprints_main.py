...
# --------------------------------------------------------------------- #
def main():
    x_train = pd.read_csv("/home/andy/andy/Inflam_NP/preprocessing/InFlam2_full_x_train.csv", index_col=0)
    x_test  = pd.read_csv("/home/andy/andy/Inflam_NP/preprocessing/InFlam2_full_x_test.csv", index_col=0)

    process_and_save_features(x_train, "canonical_smiles", "InFlam2_full_x_train")
    process_and_save_features(x_test,  "canonical_smiles", "InFlam2_full_x_test")
