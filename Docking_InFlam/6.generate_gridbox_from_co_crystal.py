...
protein_dir = Path(r"D:\Andy\Inflam_NP\Docking_InFlam\Protein_original")

ligand_map = {
    "5LOX_6NCF.pdb": "AF7",    # 5LOX
    "COX1_1EQH.pdb": "FLP",    # COX-1
    "COX2_3LN1.pdb": "CEL",    # COX-2
    "COX2_5IKR.pdb": "ID8",    # COX-2
    "mPGES1_5TL9.pdb": "7DN",    # mPGES1
}

buffer_per_side = 5.0  # Å

output_csv = "grid_centers_all_sites2.csv"
